...
export const projectsData = [
  ...
  },
  {
    ...
    description: (
      <>
        Eine Full-Stack App mit viele Funktionen: User-Login, Datenbank,
        CRUD-Operatoren, Veranschaulichung über Graphen, F.A.Q, Custom Theme.{" "}
  ...
  },
  {
    ...
    description: (
      <>
        Ein multi-site Page mit dynamic routing, umgesetzt nach einem
        professionellen Figma-Design und voll responsive.
        <a href="https://what-a-feeling.vercel.app/" target="_blank">
          <strong>Schau es dir an!</strong>
        </a>
      </>
